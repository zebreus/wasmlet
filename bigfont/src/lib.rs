//! # bigfont
//!
//! Uses a figlet font to print big letters. Luckily, someone has already written a [parser for figlet fonts](https://github.com/shurizzle/rust-figfont), so we use that for the difficult part.
use std::{
    collections::HashMap,
